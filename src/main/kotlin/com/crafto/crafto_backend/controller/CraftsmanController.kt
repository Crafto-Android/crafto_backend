...
class CraftsmanController(private val craftsmanService: CraftsmanService)
{
    ...
    fun getCraftsmanOffersByCustomerIssueId(@PathVariable customerIssueId: String) =
        craftsmanService.getOffersByCustomerIssueId(customerIssueId)
    ...
    @PostMapping("/{craftsmanId}/delete")
